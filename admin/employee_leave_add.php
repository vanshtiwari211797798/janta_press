            ...
            <form style="width: 1120px;" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="myDate" style="cursor: pointer;" name="leave_from" class="bod-picker" placeholder="YYYY-MM-DD">
                    </div>
                    <script>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="myDate2" style="cursor: pointer;" name="leave_to" class="bod-picker" placeholder="YYYY-MM-DD">
                    </div>
                    <script>
                        (() => {
