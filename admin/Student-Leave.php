...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (empty($_POST['name'])) {
        ...
        $sql = "INSERT INTO student_leave (school_id, name, class, roll_number, section, leave_from, leave_to, approved_by, application_photo, total_leave_days, total_sunday, reason) 
                VALUES ('$school_id','$name', '$class', '$roll_number', '$section', '$leave_from', '$leave_to', '$approved_by', '$fileName', '$total_leave_days', '$total_sunday', '$reason')";
            ...
            <form style="width: 1120px;" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="student-roll" name="roll_number" placeholder="Student Roll No">
                    </div>
                    <div class="form-group">
