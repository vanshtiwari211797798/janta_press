...
$sql = "SELECT * FROM student_leave WHERE school_id='$schoolId'";
if (!empty($school_id)) {
                ...
                <form method="GET">
                    ...
                    <div class="form-group">
                        ...
                        <select id="class" name="class">
                            ...
                            <?php
                            for ($i = 1; $i <= 12; $i++) {
                                echo "<option value=\"$i\" " . ($class == "$i" ? "selected" : "") . ">Class $i</option>";
                            }
                            ?>
                    ...
                    <div class="form-group">
                        ...
                        <select id="section" name="section">
                            ...
                            <?php
                            for ($ch = 'A'; $ch <= 'F'; $ch++) {
                                echo "<option value=\"$ch\" " . ($section == $ch ? "selected" : "") . ">$ch</option>";
                            }
                            ?>
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><img src="Leave_Application/<?= $record['application_photo'] ?>" height="50px" width="50px" alt="student image"></td>
                                <td><?= $record['name'] ?></td>
                                <td><?= $record['class'] ?></td>
                                <td><?= $record['section'] ?></td>
                                <td><?= $record['roll_number'] ?></td>
                                <td><?= $record['total_leave_days'] ?></td>
                                <td><a href="delete_student_leave.php?id=<?= $record['id'] ?>" style="color: red;">Delete</a></td>
                            </tr>
                    <?php
                        }
                    } else {
