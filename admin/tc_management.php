    ...
    <div id="main">
        ...
        <div class="right-main" style="padding: 10px;">
            <div id="Dashboard" class="w3-container tab-content active">
                <h1>Transfer Management (TC) Management</h1>
                <div id="content"">
                    <div class=" card student" style="background-color:rgb(77, 152, 2);">
                    <div id="card-content">
                        <h3>Requested TC</h3>
                        <p>Enter</p>
                    </div>
                    <a href="requested_tc.php">More info</a>
                </div>

                <div class=" card student" style="background-color: #a80dd3;">
                    <div id="card-content">
                        <h3>Declare TC</h3>
                        <p>Enter</p>
                    </div>
                    <a href="declare_tc.php">More info</a>
                </div>
